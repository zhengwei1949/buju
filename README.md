...
- 入群规则
    1. 尽可能不要问能百度出来的问题
    2. 问题尽可能具体详细，不要思维上懒惰，抛一个太开放的让别人没法回答的问题
    3. 每个人的时间宝贵，不要说一些与技术无关的话题
    4. 如果涉及到的代码比较多，尽可能自己写一个demo作一个压缩包传到群共享中
    5. 遇到问题自己多思考，不要懒
    6. 建一个博客(简书、博客园等)都是不错的选择，把自己遇到的问题整理成文章发布出来
    7. 经常在问别人问题的同时，如果一个问题自己知道，也尽量耐心的和别人解释明白，不要怕吃亏了
    8. 如果能持之以恒做到上面几点，2年后工资没有1万五，你可以退群了
